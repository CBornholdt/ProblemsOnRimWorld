...
{
	public class JobDriver_TraceHackingSignal : JobDriver
	{
		...
		protected override IEnumerable<Toil> MakeNewToils(){
			...
			if (pw == null) 
				yield break;
			this.AddEndCondition (() => pw.IsRunning () && !pw.HasHackingStopped () ? JobCondition.Ongoing : JobCondition.Incompletable);
			...
			foundEm.initAction = () => pw.TracedHackingSignal (foundEm.actor);
